...
<div class="topbar">
  <div class="container">
	...
	<section id="content">
        ...
        <!-- End Info Blcoks -->
        <form action="zakazi.php" method="post" class="col-xs-12 col-sm-12 col-md-12">
            <label>Izaberite kod koga zelite da zakazete pregled</label>
            <select name="doktor" id="email" class="form-control">
                <option value="Estetska stomatologija">Estetska stomatologija</option>
                <option value="Implantologija">Implantologija</option>
                <option value="Proteticar">Proteticar</option>
                <option value="Oralna hirurgija">Oralna hirurgija</option>
                <option value="Ortopedija vilica">Ortopedija vilica</option>
                <option value="Konzervativna stomatologija">Konzervativna stomatologija</option>
                <option value="Paradontologija">Paradontologija</option>
            </select> 
            <br>
            <label>Izaberite lokaciju pregleda</label>
            ...
            <br/>
              <label>Vas datum rodjenja: </label>
              <input type="date" class="form-control" id="email"  name="datum" required>  
              <input type="submit" class="btn btn-success" value="Zakazi"></input>  
        </form>
    </div>
    </section>
	<footer>
